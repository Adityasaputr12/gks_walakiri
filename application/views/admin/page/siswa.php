				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-12 mb-3">
							<div class="form-group">
								<label for="nama" class="form-label">Lingkungan </label>
								<input id="kelas" name="kelas" class="form-control" type="text" placeholder="Nama lingkungan (misalnya Lingkungan A1)" value="" required pattern="^[a-zA-Z\s]+\d*$" title="Nama lingkungan bisa mengandung teks dan angka (misalnya Lingkungan A1)">
							</div>
						</div>
					...
					<div class="row g-2">
						...
						<div class="col-md-12 mb-0 form-group">
							<label for="emailExLarge" class="form-label">Jumlah lingkungan </label>
						...
						<div class="col-md-12 mb-3">
							<div class="form-group">
								...
								<input id="ekelas" name="ekelas" class="form-control " type="text"
									placeholder="Nama lingkungan" value="" required>
...
<script>
	$(document).ready(function() {
				...
				// $.validator.addMethod("validLingkungan", function(value, element) {
